...
//voy a forzar los datos del empleado, porque no me anda cuando si querer cancelé la pantalla de login.,,.
 $user = "1000";
 $domain = "dominio";
...
if($resultEmpleados === FALSE){
	...
	echo "<h3 align=\"center\" style=\"color:red\"> Bienvenido ".$user.". Tu PC esta alojada como $domain/$workstation"."</h3><br>";	
	}
